...
public class Endocrinology_Sub_Cat_Link extends Browser_Origin {

	@Test
	public void endocrinology_link_Check() throws InterruptedException {

		Catagories_New_Pages_Framework cod = new Catagories_New_Pages_Framework(driver);

		cod.go("https://www.physiciansweekly.com/category/endocrinology/");
