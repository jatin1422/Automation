...
public class Pain_Link_Check extends Browser_Origin {

	@Test

	public void pain_link_Check() throws InterruptedException {

		Catagories_New_Pages_Framework co = new Catagories_New_Pages_Framework(driver);

		co.go("https://www.physiciansweekly.com/category/pain/");
