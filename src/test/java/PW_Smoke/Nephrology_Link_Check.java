...
public class Nephrology_Link_Check extends Browser_Origin {

	@Test

	public void nephrology_link_Check() throws InterruptedException {

		Catagories_Old_Pages_Framework co = new Catagories_Old_Pages_Framework(driver);

		co.go("https://www.physiciansweekly.com/category/nephrology/");
