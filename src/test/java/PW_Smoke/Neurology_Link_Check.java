...
public class Neurology_Link_Check extends Browser_Origin {

	@Test

	public void neurology_link_Check() throws InterruptedException {

		Catagories_Old_Pages_Framework co = new Catagories_Old_Pages_Framework(driver);

		co.go("https://www.physiciansweekly.com/category/neurology/");
