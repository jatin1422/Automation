...
public class Catagories_New_Pages_Framework extends Abst {

	public WebDriver driver;

	public Catagories_New_Pages_Framework(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void new_cat_sub_cat_tabs_link_Check() {
