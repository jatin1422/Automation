...
public class Duplicate_Articles_OB_GYN extends Browser_Origin {

	@Test
	public void duplicate_articles_OB_GYN() throws InterruptedException {

		New_Pages_Duplicates_Articles_Framework dp = new New_Pages_Duplicates_Articles_Framework(driver);

		dp.go("https://www.physiciansweekly.com/category/obgyn/");
