...
public class Family_conditon_1 {
	...
	public void medication() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='sa-button-container']/div[@class='sa-confirm-button-container']/button"))).click();

		 
	 List<WebElement> ele = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='weight']//table/tbody/tr/td[1]")));
